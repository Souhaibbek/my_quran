...
class FetchAyahAllDataUseCase extends UseCase<List<AyahEntity>, NoParam> {
  final HomeRepo homeRepo;

  FetchAyahAllDataUseCase(this.homeRepo);

  @override
  Future<Either<Failure, List<AyahEntity>>> call([NoParam? param]) async {
    return await homeRepo.fetchAllAyahData();
  }
}
